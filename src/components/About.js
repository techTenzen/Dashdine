  ...
  return (
    <div className="about-page">
      <div className="container mt-5">
        <h1 className="mb-4">About 24/7 Marts</h1>
        <p>
          24/7 Marts is your gateway to a world of culinary delights. We believe
        ...
        <p>
          Established in 2023, 24/7 Marts has rapidly evolved into a community
        ...
        <p>
          What sets 24/7 Marts apart is our commitment to variety. From
        ...
        <p>
          ...
          and every bite is a celebration. 24/7 Marts is not just a service;
          it's a journey, a community, and a feast for the senses. Let your
          taste buds explore, and let 24/7 Marts be your companion in this
          exciting culinary expedition!
        </p>
      </div>
